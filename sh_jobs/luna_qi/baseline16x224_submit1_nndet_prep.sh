#!/bin/bash
#SBATCH --job-name=luna_16_s1
#SBATCH --output=sbatch_log/luna_cos_16x224_s1_%j.out
#SBATCH --nodes=1
...
nndet_prep 023 -o +model_cfg.patch_size=[16,224,224]
#  prep=plan
...
# nndet_train 017 -o exp.fold=1 train=v001 +augment_cfg.patch_size=[16,224,224]  --sweep
