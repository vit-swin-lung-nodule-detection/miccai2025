...
nndet_train 023 -o exp.fold=0 train=v001 train.mode=resume  +augment_cfg.patch_size=[64,128,128] trainer_cfg.max_num_epochs=1 trainer_cfg.swa_epochs=10 --sweep 
