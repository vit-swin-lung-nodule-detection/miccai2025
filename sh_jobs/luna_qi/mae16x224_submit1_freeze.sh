...
#SBATCH --output=sbatch_log/luna_crop_mae_16x224_s1_freeze_adamw_poly_%j.out
#SBATCH --nodes=1
...
nndet_train 026 -o exp.fold=0 train=mae_plain +augment_cfg.patch_size=[16,224,224] trainer_cfg.freeze_encoder=True train_cfg.seperate_lr=True trainer_cfg.gradient_clip_val=0  trainer_cfg.max_num_epochs=60 trainer_cfg.swa_epochs=0 trainer_cfg.warm_iterations=4000  trainer_cfg.gradient_clip_val=0 trainer_cfg.amp_backend=None trainer_cfg.precision=32 trainer_cfg.amp_level=None --sweep 
