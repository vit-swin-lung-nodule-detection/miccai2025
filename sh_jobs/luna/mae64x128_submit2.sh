...
#SBATCH --output=sbatch_log/mae64_submit_3_debug_%j.out
#SBATCH --nodes=1
...
#
nndet_train 018 -o exp.fold=4 train=mae64 +augment_cfg.patch_size=[64,128,128] trainer_cfg.gradient_clip_val=11  trainer_cfg.max_num_epochs=5 trainer_cfg.swa_epochs=0 trainer_cfg.warm_iterations=0  trainer_cfg.gradient_clip_val=0 trainer_cfg.amp_backend=None trainer_cfg.precision=32 trainer_cfg.amp_level=None --sweep
