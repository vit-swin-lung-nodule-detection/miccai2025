#!/bin/bash
#SBATCH --job-name=64_luna_s8
#SBATCH --output=sbatch_log/baseline_nndet64x128_s8_%j.out
#SBATCH --nodes=1
...
nndet_train 018 -o exp.fold=8 train=v001 +augment_cfg.patch_size=[64,128,128] --sweep #train.mode=resume if it stopped training
#baseline64x128_submit8.sh
