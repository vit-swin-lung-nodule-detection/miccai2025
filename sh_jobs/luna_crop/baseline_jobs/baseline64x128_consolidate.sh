#!/bin/bash
#SBATCH --job-name=64_luna_predict
#SBATCH --output=sbatch_log/baseline_nndet64x128_consolidate_%j.out
#SBATCH --nodes=1
...
#1
#nndet_consolidate 018 RetinaUNetV001_D3V001_3d --sweep_boxes --shape=64_128_128 --num_folds=10
...
python prepare_eval_cpm.py 018 RetinaUNetV001_D3V001_3d --shape=64_128_128
#baseline64x128_consolidate.sh