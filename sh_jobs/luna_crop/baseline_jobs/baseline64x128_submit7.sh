#!/bin/bash
#SBATCH --job-name=64_luna_s7
#SBATCH --output=sbatch_log/baseline_nndet64x128_s7_%j.out
#SBATCH --nodes=1
...
nndet_train 018 -o exp.fold=7 train=v001 +augment_cfg.patch_size=[64,128,128] --sweep #train.mode=resume if it stopped training
#baseline64x128_submit7.sh
