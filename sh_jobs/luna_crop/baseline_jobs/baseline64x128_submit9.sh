#!/bin/bash
#SBATCH --job-name=64_luna_s9
#SBATCH --output=sbatch_log/baseline_nndet64x128_s9_%j.out
#SBATCH --nodes=1
...
nndet_train 018 -o exp.fold=9 train=v001 +augment_cfg.patch_size=[64,128,128] --sweep #train.mode=resume if it stopped training
#sbatch baseline64x128_submit9.sh
