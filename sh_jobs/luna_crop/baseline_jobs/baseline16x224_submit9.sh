#!/bin/bash
#SBATCH --job-name=16_luna_s9
#SBATCH --output=sbatch_log/baseline_nndet16x224_s9_%j.out
#SBATCH --nodes=1
...
nndet_train 017 -o exp.fold=9 train=v001 +augment_cfg.patch_size=[16,224,224] --sweep
...
#run this after 
# nndet_consolidate 017 RetinaUNetV001_D3V001_3d --shape=16_224_224 --sweep_boxes --num_folds=10
# nndet_eval 017 RetinaUNetV001_D3V001_3d 0 --boxes --analyze_boxes
