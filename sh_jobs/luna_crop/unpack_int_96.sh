#!/bin/bash
#SBATCH --job-name=unpack_int96
#SBATCH --output=sbatch_log/unpack_int_96_%j.out
#SBATCH --nodes=1
...
nndet_unpack ${det_data}/Task019_Luna_liu_prep_int_96/preprocessed/D3V001_3d/imagesTr 6 --to_int
