#!/bin/bash
#SBATCH --job-name=mo_jo_96
#SBATCH --output=sbatch_log/swin_96_monai_joint_s0_%j.out
#SBATCH --nodes=1
...
nndet_train 019 -o exp.fold=0 train=swinunetr \
...
#swinunetr_monai_joint_96x192_s0.sh
