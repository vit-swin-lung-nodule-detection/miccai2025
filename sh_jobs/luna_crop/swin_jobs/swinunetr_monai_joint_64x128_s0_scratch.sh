#!/bin/bash
#SBATCH --job-name=mo_scra_64
#SBATCH --output=sbatch_log_new/swin_64_monai_joint_scratch_s0_%j.out
#SBATCH --nodes=1
...
nndet_train 027 -o exp.fold=0 train=swinunetr \
    ...
    --sweep
#    train.mode=resume \
#swinunetr_monai_joint_64x128_s0_scratch
#upsample is transpose by default
