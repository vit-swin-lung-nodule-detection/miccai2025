#!/bin/bash
#SBATCH --job-name=mo_fre_96
#SBATCH --output=sbatch_log/swin_96_monai_freeze_s0_%j.out
#SBATCH --nodes=1
#SBATCH --time=48:00:00
#SBATCH --gres=gpu:1

#SBATCH --nodelist=octopus01,octopus02,octopus03,octopus04,bmicgpu08,bmicgpu09
...
nndet_train 028 -o exp.fold=0 train=swinunetr \
    +trainer_cfg.freeze_encoder=True \
    +augment_cfg.patch_size=[96,192,192]  \
...
#swinunetr_monai_freeze_96x192_s0.sh
