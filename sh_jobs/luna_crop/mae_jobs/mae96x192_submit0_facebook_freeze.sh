#!/bin/bash
#SBATCH --job-name=fac_f_96
#SBATCH --output=sbatch_log/facebook_freeze_96x192_s0_%j.out
#SBATCH --nodes=1
...
#sbatch mae96x192_submit0_facebook_freeze.sh