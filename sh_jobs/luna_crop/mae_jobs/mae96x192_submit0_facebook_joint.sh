#!/bin/bash
#SBATCH --job-name=fa_j_96s0
#SBATCH --output=sbatch_log/facebook_joint_96x192_s0_%j.out
#SBATCH --nodes=1
...
nndet_train 019 -o exp.fold=0 \
    train=mae96_plain +augment_cfg.patch_size=[96,192,192] \
    trainer_cfg.freeze_encoder=False trainer_cfg.gradient_clip_val=0  \
...
#sbatch mae96x192_submit0_facebook_joint.sh