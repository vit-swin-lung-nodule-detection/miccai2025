#!/bin/bash
#SBATCH --job-name=96_pre_fre_s0
#SBATCH --output=sbatch_log/mae96x192_s0_pretrain_freeze_%j.out
#SBATCH --nodes=1
...
#train.mode=resume \
#mae96x192_submit0_pretrain_freeze