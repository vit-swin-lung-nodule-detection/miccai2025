#!/bin/bash
#SBATCH --job-name=fac_jo_16
#SBATCH --output=sbatch_log/facebook_joint_16x224x224_%j.out
#SBATCH --nodes=1
...
#train.mode=resume 
#resume telling which schedule to load -> default is cosine

#sbatch mae16x224_submit0_facebook_joint.sh