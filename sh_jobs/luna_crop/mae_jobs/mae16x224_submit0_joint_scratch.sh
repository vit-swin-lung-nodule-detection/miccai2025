#!/bin/bash
#SBATCH --job-name=16_scratch
#SBATCH --output=sbatch_log_new/mae16x224_s0_joint_scratch_%j.out
#SBATCH --nodes=1
...
nndet_train 026 -o exp.fold=0 \
    ...
    trainer_cfg.gradient_clip_val=0  trainer_cfg.max_num_epochs=45 \
    ...
    model_cfg.encoder_kwargs.pretrained_path=null \
    train.mode=resume \
    --sweep

# train.mode=resume \

# mae16x224_submit0_joint_scratch.sh
