#!/bin/bash
#SBATCH --job-name=64_pre_joint_s0
#SBATCH --output=sbatch_log/mae64x128_s0_pretrain_joint_%j.out
#SBATCH --nodes=1
...
# mae64x128_submit0_pretrain_joint.sh