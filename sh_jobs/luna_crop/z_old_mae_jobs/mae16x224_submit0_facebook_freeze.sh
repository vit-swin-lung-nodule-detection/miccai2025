#!/bin/bash
#SBATCH --job-name=facebook_freeze_s0
#SBATCH --output=sbatch_log/facebook_freeze_16x224_s0_%j.out
#SBATCH --nodes=1
...
nndet_train 026 -o exp.fold=0 \
    ...
    trainer_cfg.freeze_encoder=True trainer_cfg.gradient_clip_val=0  \
...
#sbatch mae16x224_submit0_facebook_freeze.sh