#!/bin/bash
#SBATCH --job-name=s2_noskip
#SBATCH --output=sbatch_log/mae16x224_s2_joint_noskip_trans_direct%j.out
#SBATCH --nodes=1
...
# mae16x224_submit2_pretrain_joint_noskip.sh