...
from nndet.arch.encoder.modular import Encoder, VideoMAEEncoder, SwinUnetrEncoder
...
class RetinaUNetModule(LightningBaseModuleSWA):
    print("====================================")
    print("RetinaUNetModule")
    print("encoder_cls: ", Encoder)
    print("decoder_cls: ", UFPNModular)
...
class VideoMAEUNetModule(LightningBaseModuleSWA):
    print("====================================")
    print("VideoMAEUNetModule")
    # print("encoder_cls: ", Encoder)
    # print("decoder_cls: ", UFPNModular)
    # encoder_cls:  <class 'nndet.arch.encoder.modular.Encoder'>
    # decoder_cls:  <class 'nndet.arch.decoder.base.UFPNModular'>
    ...
    def _build_encoder(
        ...
        """
        # print("====================================")
        # print("plan_arch: ", plan_arch)
        # {'arch_name': 'RetinaUNetV001', 'max_channels': 320, 'start_channels': 32, 'fpn_channels': 128, 'head_channels': 128, 'classifier_classes': 1, 'seg_classes': 1, 'in_channels': 1, 'dim': 3, 'class_weight': [0.5, 0.0], 'conv_kernels': [[3, 3, 3], [3, 3, 3], [3, 3, 3], [3, 3, 3], [3, 3, 3]], 'strides': [[2, 2, 2], [2, 2, 2], [1, 2, 2], [1, 2, 2]], 'decoder_levels': (1, 2, 3, 4)}
...
class SwinUnetrUNetModule(LightningBaseModuleSWA):
    print("====================================")
    print("SwinUnetrUNetModule")
    base_conv_cls = ConvInstanceRelu
    head_conv_cls = ConvGroupRelu
    block = StackedConvBlock2
    encoder_cls = SwinUnetrEncoder
    decoder_cls = UFPNModular
    matcher_cls = IoUMatcher
    head_cls = DetectionHeadHNM
    head_classifier_cls = CEClassifier
