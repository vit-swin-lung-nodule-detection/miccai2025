#!/bin/bash
#SBATCH --job-name=16_luna_s8
#SBATCH --output=sbatch_log/baseline_nndet16x224_s8_%j.out
#SBATCH --nodes=1
...
nndet_train 017 -o exp.fold=8 train=v001 +augment_cfg.patch_size=[16,224,224] --sweep
