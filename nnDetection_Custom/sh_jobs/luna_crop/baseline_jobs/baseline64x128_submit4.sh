...
nndet_train 018 -o exp.fold=4 train=v001 +augment_cfg.patch_size=[64,128,128] --sweep #train.mode=resume if it stopped training
#baseline64x128_submit4.sh
