#!/bin/bash
#SBATCH --job-name=96_luna_s5
#SBATCH --output=sbatch_log/baseline_nndet96x192_s5_%j.out
#SBATCH --nodes=1
...
nndet_train 019 -o exp.fold=5 train=v001 train.mode=resume +augment_cfg.patch_size=[96,192,192] --sweep #train.mode=resume 
#baseline96x192_submit5.sh
