#!/bin/bash
#SBATCH --job-name=16_luna_s7
#SBATCH --output=sbatch_log/baseline_nndet16x224_s7_%j.out
#SBATCH --nodes=1
...
nndet_train 017 -o exp.fold=7 train=v001 +augment_cfg.patch_size=[16,224,224] --sweep
