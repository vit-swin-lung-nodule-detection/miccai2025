#!/bin/bash
#SBATCH --job-name=16_luna_s6
#SBATCH --output=sbatch_log/baseline_nndet16x224_s6_%j.out
#SBATCH --nodes=1
...
nndet_train 017 -o exp.fold=6 train=v001 +augment_cfg.patch_size=[16,224,224] --sweep
