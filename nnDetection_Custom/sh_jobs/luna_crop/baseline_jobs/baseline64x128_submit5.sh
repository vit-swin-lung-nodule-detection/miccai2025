#!/bin/bash
#SBATCH --job-name=64_luna_s5
#SBATCH --output=sbatch_log/baseline_nndet64x128_s4_%j.out
#SBATCH --nodes=1
...
nndet_train 018 -o exp.fold=5 train=v001 +augment_cfg.patch_size=[64,128,128] --sweep #train.mode=resume if it stopped training
#baseline64x128_submit5.sh
