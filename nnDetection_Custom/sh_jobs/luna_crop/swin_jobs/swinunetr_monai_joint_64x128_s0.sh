#!/bin/bash
#SBATCH --job-name=mo_jo_64
#SBATCH --output=sbatch_log/swin_64_monai_joint_s0_%j.out
#SBATCH --nodes=1
...
nndet_train 018 -o exp.fold=0 train=swinunetr \
    ...
    train.mode=resume \
    model_cfg.encoder_kwargs.pretrained_path=/usr/bmicnas02/data-biwi-01/lung_detection/pretrain_swin/swin_unetr.base_5000ep_f48_lr2e-4_pretrained.pt --sweep

#swinunetr_monai_joint_64x128_s0.sh
