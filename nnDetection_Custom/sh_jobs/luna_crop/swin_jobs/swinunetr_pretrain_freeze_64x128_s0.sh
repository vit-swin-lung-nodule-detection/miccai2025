#!/bin/bash
#SBATCH --job-name=64_pre_fre
#SBATCH --output=sbatch_log_new/swin_64_pretrain_freeze_s0_%j.out
#SBATCH --nodes=1
...
nndet_train 024 -o exp.fold=0 train=swinunetr \
...
#train.mode=resume \
#swinunetr_pretrain_freeze_64x128_s0.sh