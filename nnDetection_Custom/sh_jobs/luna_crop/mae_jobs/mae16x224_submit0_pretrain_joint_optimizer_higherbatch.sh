#!/bin/bash
#SBATCH --job-name=highbatch
#SBATCH --output=sbatch_log_new/mae16x224_s0_pretrain_joint_optimizer_highbatch%j.out
#SBATCH --nodes=1
...
nndet_train 023 -o exp.fold=0 \
    ...
    trainer_cfg.num_train_batches_per_epoch=6000 \
...
# mae16x224_submit0_pretrain_joint_optimizer_higherbatch.sh
