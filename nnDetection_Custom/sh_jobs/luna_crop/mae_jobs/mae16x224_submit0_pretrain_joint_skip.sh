#!/bin/bash
#SBATCH --job-name=16_pre_sk_join_s0
#SBATCH --output=sbatch_log_new/mae16x224_s0_pretrain_joint_SKIP_%j.out
#SBATCH --nodes=1
...
#train.mode=resume \
# mae16x224_submit0_pretrain_joint_skip.sh
#originally in fold 20 but moved to 26 to finish training, remember to move it back to 20
