#!/bin/bash
#SBATCH --job-name=64_pre_fre_s0
#SBATCH --output=sbatch_log/mae64x128_s0_pretrain_freeze_%j.out
#SBATCH --nodes=1
...
nndet_train 024 -o exp.fold=0 \
    ...
    trainer_cfg.swa_epochs=2 trainer_cfg.warm_iterations=4000  \
    ...
    model_cfg.encoder_kwargs.pretrained_path=/usr/bmicnas02/data-biwi-01/lung_detection/pretrain_mae/output/pretrain_64_128_128/checkpoint-00150_64_128_128.pth \
    train.mode=resume \
    --sweep

#train.mode=resume \
#mae64x128_submit0_pretrain_freeze