#!/bin/bash
#SBATCH --job-name=64_scratch
#SBATCH --output=sbatch_log/mae64x128_s0_joint_scratch_%j.out
#SBATCH --nodes=1
#SBATCH --time=8:00:00
#SBATCH --gres=gpu:1
...
nndet_train 027 -o exp.fold=0 \
    ...
    trainer_cfg.gradient_clip_val=0  trainer_cfg.max_num_epochs=40 \
...
# mae64x128_submit0_joint_scratch.sh