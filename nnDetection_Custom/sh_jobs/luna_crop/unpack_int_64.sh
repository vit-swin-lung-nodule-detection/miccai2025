#!/bin/bash
#SBATCH --job-name=unpack_int64
#SBATCH --output=sbatch_log/unpack_int_64_%j.out
#SBATCH --nodes=1
...
nndet_unpack ${det_data}/Task018_Luna_liu_prep_int_64/preprocessed/D3V001_3d/imagesTr 6 --to_int
