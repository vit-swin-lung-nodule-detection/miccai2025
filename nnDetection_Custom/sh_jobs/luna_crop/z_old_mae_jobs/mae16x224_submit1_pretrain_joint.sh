#!/bin/bash
#SBATCH --job-name=s1_skip
#SBATCH --output=sbatch_log/mae16x224_s1_joint_skip_inter_grad%j.out
#SBATCH --nodes=1
...
# mae16x224_submit1_pretrain_joint.sh