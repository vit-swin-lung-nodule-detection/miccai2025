#!/bin/bash
#SBATCH --job-name=s1_noskip
#SBATCH --output=sbatch_log/mae16x224_s1_joint_noskip_inter_gradually%j.out
#SBATCH --nodes=1
...
# mae16x224_submit1_pretrain_joint_noskip.sh