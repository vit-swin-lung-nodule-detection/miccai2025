...
#SBATCH --output=sbatch_log/luna_crop_mae_16x224_fold3_pretrain_%j.out
#SBATCH --nodes=1
...
nndet_train 017 -o exp.fold=2 \
    ...
    model_cfg.encoder_kwargs.pretrained_path=/usr/bmicnas02/data-biwi-01/lung_detection/nnDetection_Custom/checkpoints/mae16/checkpoint-00100.pth --sweep
