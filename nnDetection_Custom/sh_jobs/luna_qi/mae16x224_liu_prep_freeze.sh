...
nndet_train 26 -o exp.fold=0 train=mae +augment_cfg.patch_size=[16,224,224] trainer_cfg.freeze_encoder=True trainer_cfg.decoder_lr=1e-4 trainer_cfg.gradient_clip_val=0  trainer_cfg.max_num_epochs=50 trainer_cfg.swa_epochs=10 trainer_cfg.warm_iterations=4000  trainer_cfg.gradient_clip_val=0 trainer_cfg.amp_backend=None trainer_cfg.precision=32 trainer_cfg.amp_level=None --sweep
